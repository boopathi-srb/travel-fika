...
const FlightSearchForm: FC<FlightSearchFormProps> = ({ haveDefaultValue }) => {
                    ...
                    <div className="relative grid gap-8 bg-white dark:bg-neutral-800 p-7 ">
                      {flightClass.map((item) => (
                        <a
                          ...
                          className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                        >
  ...
  const renderRadioBtn = () => {
    return (
      <div className=" py-5 [ nc-hero-field-padding ] flex flex-row flex-wrap justify-content: space-evenly border-b border-neutral-100 dark:border-neutral-700">
        <div
        ...
        <div className=" mr-2 my-1 flex items-center justify-content:center sm:mr-4 border border-neutral-300 dark:border-neutral-700 rounded-full">
          {renderSelectClass()}
        </div>
        <div className="mr-2 my-1 border border-neutral-300 dark:border-neutral-700 rounded-full">
          {/* {renderGuest()} */}
          <GuestsInput
